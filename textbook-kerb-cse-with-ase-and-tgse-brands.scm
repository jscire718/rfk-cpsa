...
;	* In this version, we add the ASE and TGSE brands in user's response messages to 
;	* show the elimination of the Man-in-the-Middle attacks (Problematic Shapes #1 and #2)
;
;
...
(herald textbook-kerb-cse-with-ase-and-tgse-brands (bound 20) (limit 8000))

(defprotocol textbook-kerb-cse-with-ase-and-tgse-brands basic
...
(defskeleton textbook-kerb-cse-with-ase-and-tgse-brands
